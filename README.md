...
* class_counts_clean = class_counts.loc[class_counts > 1]

* categorical_list = application_df.dtypes[application_df.dtypes == 'object'].index.tolist()

* dummy_data = pd.get_dummies(application_df, drop_first=True)

* filePath = r"C:\Users\theli\Desktop\Gitlab\deep-learning-challenge\AlphabetSoupCharity.h5"
